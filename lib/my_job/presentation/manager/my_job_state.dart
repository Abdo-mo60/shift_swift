...
class RemoveSavedjobcubitLoading extends MyJobState {}

class RemoveSavedjobcubitSuccess extends MyJobState {}

class RemoveSavedjobcubitFailure extends MyJobState {
  final String erorrMessage;

  RemoveSavedjobcubitFailure({required this.erorrMessage});
}
